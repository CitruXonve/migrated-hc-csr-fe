...
const SAFETY_CENTER_ROUTES_MAP: StringMap = {
  ...
  '/safety/resources/suicide-hotline-resources':
    '/safety/{{lang}}/suicide-self-harm/',
  ...
  '/safety/resources/privacy-and-security':
    '/safety/{{lang}}/privacy-and-security-on-tiktok',
};
...
transposeMap(
  ARTICLE_TO_COMMUNITY_GUIDELINES_MAP,
