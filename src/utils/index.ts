...
export function getDownloadLinkParam(page: string): { af_adset_id: string; pid: string } {
  const param = {
    af_adset_id: page,
    pid: 'tiktokweb',
  };
...
export function getDownloadLinkCode(page: string): { pageName: string; launchMode: string; trafficType: string } {
