...
const SUPPORT = 'tk-hc-dev.citruxonve.net';

// Domains for online environment.
const TTP_SUPPORT = 'tk-hc-dev.citruxonve.net';
const TTP_SUPPORT_TIKTOKW = 'tk-hc-dev.citruxonve.net';
const TTP2_SUPPORT_TIKTOKW = 'tk-hc-dev.citruxonve.net';

// Domain for local development.
const DEV_SUPPORT = 'localhost:8080';

// domain for ie
const IE_SUPPORT = 'tk-hc-dev.citruxonve.net';
